...
for i in range(0, last_page, 10):
    ...
    for link in soup.find_all('a'):
        ...
        if entscheidungen_url in href:
            ...
            elements.append({'id': id, 'url':details_url, 'title': title, 'leitsaetze': leitsaetze_text})
            print(f"{ctr}: Added {id}")
            ctr += 1
